                        ...
                        <div class="row">
                            ...
                            <div class="col-2 br-right">
                                <div class="inner-left">
                                    ...
                                    <h3 class="success_color text-center">3</h3>
                                </div>
                            </div>
                            <div class="col-2 br-right">
                                <div class="inner-left">
                                    <p class="warning_color text-center">未完成</p>
                                    <h3 class="warning_color text-center">2</h3>
                                </div>
                            </div>
                            <div class="col-2 br-right">
                                <div class="inner-left">
                                    <p class="critical_color text-center">異常</p>
                                    <h3 class="critical_color text-center">2</h3>
                                </div>
                            </div>
                            <div class="col-3">
        ...
        <div class="bill-content  mt-5  mb-9">
            <div class="tf-container">
                ...
                <h3 class="fw_6 d-flex  mt-3 mb-1"><svg width="25" height="24" viewBox="0 0 25 24" fill="none"
                    ...
                    </svg> 今日派發出貨單<span v-if="TotalRowsCount != 0"> ({{ DepotHeadList.length }}/{{ TotalRowsCount
                        }})</span>
                </h3>
                <hr class="mt-2">
                <ul class="mt-3 mb-5">
                ...
                <h3 class="fw_6 d-flex justify-content-between mt-5">更多功能 </h3>
            ...
            <div class="tf-container">
                <ul class="tf-navigation-bar">
                    <li class="active"><a class="fw_6 d-flex justify-content-center align-items-center flex-column"
                            href="/home"><i class="icon-home2"></i> 主控台</a> </li>
                    <li><a class="fw_4 d-flex justify-content-center align-items-center flex-column"
                            href="javascript:;"><svg width="25" height="24" viewBox="0 0 25 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li><a class="fw_4 d-flex justify-content-center align-items-center flex-column"
                            href="javascript:;"><i class="icon-history"></i> 歷史任務</a> </li>
